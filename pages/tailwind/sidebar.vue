<template>
    ...
    <div id="sidebar" class="bg-blue-600 text-blue-100 w-64 space-y-6 py-7 z-20 px-2 absolute inset-y-0 left-0 transform transition duration-200 ease-in-out -translate-x-full">
        ...
        <span class="text-xl font-bold">Menu Developer</span>
        </a>

        <!-- nav -->
        <nav>
        <a href="#" class="flex py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700 hover:text-white">
        ...
        <a href="" class="flex py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700 hover:text-white">
            ...
            <span  class="text-xl font-medium">Features</span> 
        </a>
        <a href="" class="flex py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2">
